...
- **GitHub**: [offsideai/marketingskills](https://github.com/offsideai/marketingskills)
- **Creator**: Arunabh Das
- **License**: MIT
...
1. **Once per session**, on first skill use, check for updates:
   - Fetch `VERSIONS.md` from GitHub: https://raw.githubusercontent.com/offsideai/marketingskills/main/VERSIONS.md
